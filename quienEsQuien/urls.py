...
from quienEsQuien.views import introduccion, prediccion, explicatividad, login_user, register, password, loginError, logout_user, saveData, saveRecogidaDatos, recogidaDatos #importamos la vista que esta en el archivo views de mi proyecto DjangoTFG
